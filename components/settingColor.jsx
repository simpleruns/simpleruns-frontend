...
export default function SettingColor(props) {
    ...
    return (
        data && <div class="mt-[3px] flex h-[61px] w-[150px] backdrop-blur-xl flex-grow items-center justify-around gap-2 rounded-full px-2 py-2 shadow-xl shadow-shadow-500 dark:shadow-none md:w-[150px] md:flex-grow-0 md:gap-1 xl:w-[150px] xl:gap-2 fixed top-[30px] right-[35px] !z-[99]">
            <button
