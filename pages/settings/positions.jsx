...
function SelectBox() {
    ...
    const handleOptionChange = (event) => {
        ...
        event.target.value == 'other' ? setInputValue('') : setInputValue(event.target.value);
    };
    ...
    return (
        <>
            <div className="relative flex items-center">
                <select id="select-box" name="select-box" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mr-4" onChange={handleOptionChange}>
                ...
                {
                    selectedOption == 'other' && <input type="text" value={inputValue} onChange={handleInputChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter an option" />
                }
            </div>
            {selectedOption && (
                <p className="mt-2 text-lg font-medium">You selected: {inputValue}</p>
            )}
        </>
    );
}
